#!/bin/bash
# ============================================================
# Resubmit failed jobs with batch_size=32 to fix OOM
# Usage: bash resubmit_failed_v2.sh <username>
# ============================================================
...
# OOM jobs - resubmit with batch_size=32
...
# M2PO - fixed (no use_m2po_loss flag, just set threshold)
...
echo ""
echo "All failed jobs resubmitted with batch_size=32!"
